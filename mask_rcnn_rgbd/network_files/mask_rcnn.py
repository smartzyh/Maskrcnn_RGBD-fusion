...
class MaskRCNN(FasterRCNN):
    ...
    def __init__(
        ...
        if mask_roi_pool is None: #调整大小为14x14
            mask_roi_pool = MultiScaleRoIAlign(featmap_names=["0", "1", "2", "3"], output_size=14, sampling_ratio=2)

        if mask_head is None: #3个3x3的卷积
...
class MaskRCNNPredictor(nn.Sequential):#最后一层卷积
