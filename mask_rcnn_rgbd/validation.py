...
def save_info(coco_evaluator,
    ...
    for i in range(1, len(classes) + 1):
        ...
        voc_map_info_list.append(" {:15}: {}".format(classes[i-1], stats[1]))  # 每一类的指数
...
def main(parser_data):
    ...
    det_metric = EvalCOCOMetric(val_dataset.coco, "bbox", "./results/res101-real/det_results1.json")
    seg_metric = EvalCOCOMetric(val_dataset.coco, "segm", "./results/res101-real/seg_results1.json")
    model.eval()

    numclass = 4

    conf_matrix = torch.zeros(numclass, numclass)
    ...
    save_info(det_metric.coco_evaluator, category_index, "./results/res101-real/det_record_mAP1.txt")
    save_info(seg_metric.coco_evaluator, category_index, "./results/res101-real/seg_record_mAP1.txt")
...
if __name__ == "__main__":
    ...
    # 数据集的根目录
    parser.add_argument('--data-path', default='./data/coco2022', help='dataset root')

    # 训练好的权重文件
    parser.add_argument('--weights-path', default='./save_weights/rgbd101-real/model_198.pth', type=str, help='training weights')
